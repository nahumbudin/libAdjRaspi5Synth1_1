/**
*	@file		adjSynthDefaultPatchParamsFilter.cpp
*	@author		Nahum Budin
*	@date		4-Oct-2024
*	@version	1.2
...
int AdjSynth::set_default_patch_parameters_filter(_settings_params_t *params, int prog)
{
	int res;
	...
	res = adj_synth_settings_manager->set_int_param
		...
		(int)((1000.0f - _FILTER_MIN_CENTER_FREQ) / (float)(((float)sample_rate / 6.7) - 
				_FILTER_MIN_CENTER_FREQ) * 100.0f), // max filter center frequency
		100,
		0,
