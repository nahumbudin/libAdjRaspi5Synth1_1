/**
*	@file		adjSynthDefaultPatchParamsModulators.cpp
*	@author		Nahum Budin
*	@date		4-Oct-2024
*	@version	1.1
...
int AdjSynth::set_default_patch_parameters_modulators(_settings_params_t *params, int prog)
{
	int res;
