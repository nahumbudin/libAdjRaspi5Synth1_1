...
AdjPolyphonyManagerThreads *AdjPolyphonyManagerThreads::poly_manager_instance = NULL;

AdjPolyphonyManagerThreads::AdjPolyphonyManagerThreads(int num_of_voices)
{
...
AdjPolyphonyManagerThreads *AdjPolyphonyManagerThreads::get_poly_manger_instance(int num_of_voices)
{
	if (poly_manager_instance == NULL)
	{
		poly_manager_instance = new AdjPolyphonyManagerThreads(num_of_voices);
	}

	return poly_manager_instance;
}

int AdjPolyphonyManagerThreads::get_number_of_cores()
{
	return number_of_cores;
}

int AdjPolyphonyManagerThreads::increase_core_processing_load_weight(int core, int wght)
{
...
int AdjPolyphonyManagerThreads::decrease_core_processing_load_weight(int core, int wght)
{
	if ((core < number_of_cores) && (wght > 0))
	{
		cores_load[core] -= wght;
...
int AdjPolyphonyManagerThreads::get_core_processing_load_weight(int core)
{
...
int AdjPolyphonyManagerThreads::clear_core_processing_load_weight(int core)
{
	if (core < number_of_cores)
	{
		cores_load[core] = 0;
...
int AdjPolyphonyManagerThreads::get_less_busy_core()
{
...
*/
int AdjPolyphonyManagerThreads::get_a_free_voice(int core)
{
...
*/
int AdjPolyphonyManagerThreads::get_oldest_voice()
{
...
*/
int AdjPolyphonyManagerThreads::get_reused_note(int note, int program)
{
...
*   @return 0 if done.
*/
int AdjPolyphonyManagerThreads::activate_resource(int res_num, int note, int program)
{
...
*   @return tvoid
*/
void AdjPolyphonyManagerThreads::free_voice(int voice, bool pend)
{
