...
*		1. Blocked Mode - no new voce-block will be allocated until there is at least one Not-Active voice block.
...
class AdjPolyphonyManagerThreads
{
  public:
	static AdjPolyphonyManagerThreads *get_poly_manger_instance(int num_of_voices);
  ...
  private:
	AdjPolyphonyManagerThreads(int num_of_voic = 4);

	static AdjPolyphonyManagerThreads *poly_manager_instance;
