...
{
	AdjSynth::get_instance()->audio_poly_mixer->set_program_level_1(chan, lev);
	AdjSynth::get_instance()->audio_poly_mixer->set_program_level_2(chan, lev);
	return 0;
}

int set_mixer_channel_pan_cb(int pan, int chan)
{
	AdjSynth::get_instance()->audio_poly_mixer->set_program_pan_1(chan, pan);
	AdjSynth::get_instance()->audio_poly_mixer->set_program_pan_2(chan, pan);
	return 0;
}

int set_mixer_channel_send_cb(int snd, int chan)
{
	AdjSynth::get_instance()->audio_poly_mixer->set_program_send_1(chan, snd);
	AdjSynth::get_instance()->audio_poly_mixer->set_program_send_2(chan, snd);
	return 0;
}
...
{
	AdjSynth::get_instance()->audio_poly_mixer->set_lfo_1_waveform(wavf);
	return 0;
}

int set_mixer_lfo_2_waveform_cb(int wavf, int chan)
{
	AdjSynth::get_instance()->audio_poly_mixer->set_lfo_2_frequency(wavf);
	return 0;
}

int set_mixer_lfo_3_waveform_cb(int wavf, int chan)
{
	AdjSynth::get_instance()->audio_poly_mixer->set_lfo_3_waveform(wavf);
	return 0;
}

int set_mixer_lfo_4_waveform_cb(int wavf, int chan)
{
	AdjSynth::get_instance()->audio_poly_mixer->set_lfo_4_waveform(wavf);
	return 0;
}

int set_mixer_lfo_5_waveform_cb(int wavf, int chan)
{
	AdjSynth::get_instance()->audio_poly_mixer->set_lfo_5_waveform(wavf);
	return 0;
}
...
{
	AdjSynth::get_instance()->audio_poly_mixer->set_lfo_1_frequency(rate);
	return 0;
}

int set_mixer_lfo_2_rate_cb(int rate, int chan)
{
	AdjSynth::get_instance()->audio_poly_mixer->set_lfo_2_frequency(rate);
	return 0;
}

int set_mixer_lfo_3_rate_cb(int rate, int chan)
{
	AdjSynth::get_instance()->audio_poly_mixer->set_lfo_3_frequency(rate);
	return 0;
}

int set_mixer_lfo_4_rate_cb(int rate, int chan)
{
	AdjSynth::get_instance()->audio_poly_mixer->set_lfo_4_frequency(rate);
	return 0;
}

int set_mixer_lfo_5_rate_cb(int rate, int chan)
{
	AdjSynth::get_instance()->audio_poly_mixer->set_lfo_5_frequency(rate);
	return 0;
}
...
{
	AdjSynth::get_instance()->audio_poly_mixer->set_lfo_1_stmmetry(sym);
	return 0;
}

int setmixer_lfo_2_symmetry_cb(int sym, int chan)
{
	AdjSynth::get_instance()->audio_poly_mixer->set_lfo_2_stmmetry(sym);
	return 0;
}

int setmixer_lfo_3_symmetry_cb(int sym, int chan)
{
	AdjSynth::get_instance()->audio_poly_mixer->set_lfo_3_stmmetry(sym);
	return 0;
}

int setmixer_lfo_4_symmetry_cb(int sym, int chan)
{
	AdjSynth::get_instance()->audio_poly_mixer->set_lfo_4_stmmetry(sym);
	return 0;
}
