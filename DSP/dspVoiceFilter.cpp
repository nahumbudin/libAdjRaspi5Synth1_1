...
*	@return none
*/
void DSP_Voice::set_filter_1_freq_mod_lfo_level(int lev) 
{ 
	if ((lev >= 0) && (lev <= 100))
	{
...
*	@return none
*/
void DSP_Voice::set_filter_1_freq_mod_env_level(int lev) 
{ 
	if ((lev >= 0) && (lev <= 100)) 
	{ 
...
*/
int DSP_Voice::get_filter_1_freq_mod_lfo() 
{ 
...
*/
float DSP_Voice::get_filter_1_freq_mod_lfo_level() 
{ 
...
*/
int DSP_Voice::get_filter_1_freq_mod_env() 
{ 
...
*	@param	none
*	@return Filter_1 active ENV frequency modulator level
*/
float DSP_Voice::get_filter_1_freq_mod_env_level() 
{ 
...
*	@return none
*/
void DSP_Voice::set_filter_1_freq_lfo_modulation(float mod_factor, float mod_val)
{
	float value = mod_val;
	...
	filter_1_freq_lfo_modulation = factor * value / 0.8f; 
}
...
*	@return none
*/
void DSP_Voice::set_filter_1_freq_env_modulation(float mod_factor, float mod_val)
{
	float factor = mod_factor;
	if (factor < 0.0f)
	{
	...
	filter_1_freq_env_modulation = factor * value; 
}
...
*	@return none
*/
void DSP_Voice::set_filter_2_freq_mod_lfo_level(int lev) 
{ 
	if ((lev >= 0) && (lev <= 100))
	{
...
*	@return none
*/
void DSP_Voice::set_filter_2_freq_mod_env_level(int lev) 
{ 
	if ((lev >= 0) && (lev <= 100)) 
	{
...
*/
int DSP_Voice::get_filter_2_freq_mod_lfo() 
{ 
...
*/
float DSP_Voice::get_filter_2_freq_mod_lfo_level() 
{ 
...
*/
int DSP_Voice::get_filter_2_freq_mod_env() 
{ 
...
*/
float DSP_Voice::get_filter_2_freq_mod_env_level() 
{ 
...
*	@return none
*/
void DSP_Voice::set_filter_2_freq_lfo_modulation(float mod_factor, float mod_val)
{
	float value = mod_val;
	...
	filter_2_freq_lfo_modulation = factor * value / 0.8f; 
}
...
*	@return none
*/
void DSP_Voice::set_filter_2_freq_env_modulation(float mod_factor, float mod_val)
{
	float factor = mod_factor;
	if (factor < 0.0f)
	{
	...
	filter_2_freq_env_modulation = factor * value; 
}
