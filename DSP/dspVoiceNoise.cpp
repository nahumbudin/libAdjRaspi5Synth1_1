...
*	@return void
*/
void DSP_Voice::set_noise_1_send_filter_1_level(float lev)
{
...
*	@return void
*/
void DSP_Voice::set_noise_1_send_filter_1_level(int lev)
{
...
*/
float DSP_Voice::get_noise_1_send_filter_1_level() { return noise_1_send_filter_1_level; }
...
*	@return void
*/
void DSP_Voice::set_noise_1_send_filter_2_level(float lev)
{
...
*	@return void
*/
void DSP_Voice::set_noise_1_send_filter_2_level(int lev)
{
...
*/
float DSP_Voice::get_noise_1_send_filter_2_level() { return noise_1_send_filter_2_level; }
...
*	@return none
*/
void DSP_Voice::set_noise_1_amp_mod_lfo_level(int lev) 
{
	if ((lev >= 0) && (lev <= 100))
	{
...
*	@return none
*/
void DSP_Voice::set_noise_1_amp_mod_env_level(int lev) 
{ 
	if ((lev >= 0) && (lev <= 100))
	{
...
*	@param	none
*	@return Noise_1 active LFO amplitude modulator number
*/
int DSP_Voice::get_noise_1_amp_mod_lfo() 
{ 
...
*/
float DSP_Voice::get_noise_1_amp_mod_lfo_level() 
{ 
...
*/
int DSP_Voice::get_noise_1_amp_mod_env() 
{ 
...
*/
float DSP_Voice::get_noise_1_amp_mod_env_level() { return noise_1_amp_mod_env_level; }
...
*	@return none
*/
void DSP_Voice::set_noise_1_amp_lfo_modulation(float mod_factor, float mod_val)
{
	float value = mod_val; // Modulation value (LFO: -1.0 to 1.0; Env: 0 to 1.0)
	
	if (adsr_1->note_on_elapsed_time < noise_1_amp_mod_lfo_delay)
	{
		// Delayed activation
		value = 0.5f;
	}
	...
	noise_1_amp_lfo_modulation = 1 - (1.0f + value) * factor / 2.0f;
}
...
*	@return none
*/
void DSP_Voice::set_noise_1_amp_env_modulation(float mod_factor, float mod_val)
{
	...
	noise_1_amp_env_modulation = factor * value; 
}
