...
{
	res_noise = settings_manager->get_bool_param(AdjSynth::get_instance()->get_active_patch_params(),
...
{
	res_noise = settings_manager->get_int_param(AdjSynth::get_instance()->get_active_patch_params(),
