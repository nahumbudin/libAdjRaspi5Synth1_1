/**
*	@file		modSynthPreset.cpp
*	@author		Nahum Budin
*	@date		17-Oct-2024
*	@version	1.2
*					1. Code refactoring and notaion.
*
*	@brief		Used for saving and restoring a full setup of the synthesizer
*
*	History:\n
*
...
mod_synth_preset_t ModSynthPresets::synth_presets[_NUM_OF_PRESETS];
string ModSynthPresets::preset_summary_text[_NUM_OF_PRESETS] = { "" };
int ModSynthPresets::active_preset = 0;
...
*/
int ModSynthPresets::generate_summary(mod_synth_preset_t *preset, std::string *summary)
{
...
*/
int ModSynthPresets::set_synth_settings(mod_synth_preset_t *preset) 
{
	return_val_if_true(preset == NULL, _SETTINGS_BAD_PARAMETERS);
...
*/
mod_synth_preset_t *ModSynthPresets::get_synth_preset_params(int preset_num)
{
...
*/
string *ModSynthPresets::get_synth_preset_summary_text(int preset_num)
{
	if ((preset_num < 0) || (preset_num >= _NUM_OF_PRESETS))
	{
		return NULL;
...
*   @return void
*/
void ModSynthPresets::copy_presets(mod_synth_preset_t *src, mod_synth_preset_t *dest)
{
...
*   @return void
*/
void ModSynthPresets::set_active_preset(int preset)
{
...
*/
int ModSynthPresets::get_active_preset() { return active_preset; }
